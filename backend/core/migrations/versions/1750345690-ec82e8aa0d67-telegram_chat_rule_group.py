...
def downgrade() -> None:
    op.drop_constraint('telegram_chat_whitelist_external_source_group_id_fkey', 'telegram_chat_whitelist_external_source', type_='foreignkey')
    ...
    op.drop_constraint('telegram_chat_whitelist_group_id_fkey', 'telegram_chat_whitelist', type_='foreignkey')
    op.drop_column('telegram_chat_whitelist', 'grants_write_access')
    op.drop_column('telegram_chat_whitelist', 'group_id')
    op.drop_constraint('telegram_chat_toncoin_group_id_fkey', 'telegram_chat_toncoin', type_='foreignkey')
    op.drop_column('telegram_chat_toncoin', 'group_id')
    op.drop_constraint('telegram_chat_sticker_collection_group_id_fkey', 'telegram_chat_sticker_collection', type_='foreignkey')
    op.drop_column('telegram_chat_sticker_collection', 'group_id')
    op.drop_constraint('telegram_chat_premium_group_id_fkey', 'telegram_chat_premium', type_='foreignkey')
    op.drop_column('telegram_chat_premium', 'grants_write_access')
    op.drop_column('telegram_chat_premium', 'group_id')
    op.drop_constraint('telegram_chat_nft_collection_group_id_fkey', 'telegram_chat_nft_collection', type_='foreignkey')
    op.drop_column('telegram_chat_nft_collection', 'group_id')
    op.drop_constraint('telegram_chat_jetton_group_id_fkey', 'telegram_chat_jetton', type_='foreignkey')
    op.drop_column('telegram_chat_jetton', 'group_id')
    op.drop_constraint('telegram_chat_gift_collection_group_id_fkey', 'telegram_chat_gift_collection', type_='foreignkey')
