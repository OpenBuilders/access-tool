...
CATEGORY_TO_METHOD_BY_ASSET_MAPPING: dict[
    str, dict[NftCollectionCategoryType, Callable[[list[NftItem]], list[NftItem]]]
] = {
    NftCollectionAsset.TELEGRAM_NUMBER: {
        # Telegram Numbers
    ...
    NftCollectionAsset.TELEGRAM_USERNAME: {
        # Telegram Usernames
    ...
    NftCollectionAsset.TELEGRAM_GIFTS: {
        # Gifts
