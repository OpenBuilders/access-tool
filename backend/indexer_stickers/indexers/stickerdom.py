...
class StickerDomService:
    def __init__(self) -> None:
        self.private_key = load_private_key(
            stickers_indexer_settings.sticker_dom_private_key_path
        )

    @staticmethod
    def _get_ownership_url(collection_id: int) -> str:
        return (
            f"{stickers_indexer_settings.sticker_dom_base_url}/data/ownership"
            f"?consumer_id={stickers_indexer_settings.sticker_dom_consumer_id}"
            f"&collection_id={collection_id}"
        )

    @staticmethod
    def _get_collections_url() -> str:
        return f"{stickers_indexer_settings.sticker_dom_data_storage_base_url}/collections.json"
